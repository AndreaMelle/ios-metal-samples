...
@interface OBJModel ()
{
    ...
    std::vector<VertexType> groupVertices;
...
- (void)endCurrentGroup
{
    ...
    NSData *vertexData = [NSData dataWithBytes:groupVertices.data() length:sizeof(VertexType) * groupVertices.size()];
...
- (void)generateNormalsForCurrentGroup
{
    ...
    for (i = 0; i < indexCount; i += 3)
    {
        ...
        VertexType *v0 = &groupVertices[i0];
        VertexType *v1 = &groupVertices[i1];
        VertexType *v2 = &groupVertices[i2];
