...
@interface MainBundleTextureProvider ()
@property (nonatomic, strong) id<MTLTexture> texture;
@end

@implementation MainBundleTextureProvider
...
- (instancetype)initWithImageNamed:(NSString *)imageName context:(ComputeContext *)context
{
    if ((self = [super init]))
    {
...
- (id<MTLTexture>)textureForImage:(UIImage *)image context:(ComputeContext *)context
{
